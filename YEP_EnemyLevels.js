...
//=============================================================================
 /*:
 * @plugindesc【Lvタグ空白置換で削除】 v1.09 This plugin enables giving your enemies levels and
 ...
 *
 *   <StaticLevel: x> ←空白があるとメタで値取得できなかったため空白削除
...
DataManager.processELVNotetags1 = function(group) {
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      } else if (line.match(/<(?:SET LEVEL|STATICLEVEL):[ ](\d+)>/i)) {
        obj.minLevel = parseInt(RegExp.$1);
        obj.maxLevel = parseInt(RegExp.$1);
